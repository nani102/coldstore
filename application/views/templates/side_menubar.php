    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if($user_permission): ?>
          ...
          <?php if(in_array('createInward', $user_permission) || in_array('updateInward', $user_permission) || in_array('viewInward', $user_permission) || in_array('deleteInward', $user_permission)): ?>
            <li class="treeview" id="mainInwardNav">
              ...
              <ul class="treeview-menu">
                <?php if(in_array('createInward', $user_permission)): ?>
                  <li id="addInwardNav"><a href="<?php echo base_url('inwards/create') ?>"><i class="fa fa-circle-o"></i> Add Inward</a></li>
                <?php endif; ?>
                <?php if(in_array('updateInward', $user_permission) || in_array('viewInward', $user_permission) || in_array('deleteInward', $user_permission)): ?>
                <li id="manageInwardNav"><a href="<?php echo base_url('inwards') ?>"><i class="fa fa-circle-o"></i> Manage Inwards</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
